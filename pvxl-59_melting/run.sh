python python3_insane_M3_lipids.py -salt 0.15 -sol W -o l59_standard.gro -l L59:1 -p topol.top -pbc hexagonal -box 9,9,9,0,0,5,0,0,0 # slanted to avoid pbc artifacts in the gel state
